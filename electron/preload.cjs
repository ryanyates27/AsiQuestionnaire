...
contextBridge.exposeInMainWorld("api", {
  ...
  pb: {
    ...
    debugArchiveCreate: () => ipcRenderer.invoke("pb.debugArchiveCreate"), // ADDED
  },
  ...
  removeArchiveEntry: (payload) =>
    ipcRenderer.invoke("removeArchiveEntry", payload),
  downloadArchiveEntry: (payload) =>
    ipcRenderer.invoke("downloadArchiveEntry", payload),
  getArchivePreviewUrl: (payload) =>
    ipcRenderer.invoke("getArchivePreviewUrl", payload), // ADDED
  getArchivePreviewDataUrl: (payload) =>
    ipcRenderer.invoke("getArchivePreviewDataUrl", payload),

  // CHANGED/ADDED: publish local PDFs to PocketBase
  archive: {
    publish: () => ipcRenderer.invoke("archive.publish"),
    downloadYear: (payload) =>
      ipcRenderer.invoke("archive.downloadYear", payload), // { siteName, year }
    deleteYear: (payload) => ipcRenderer.invoke("archive.deleteYear", payload), // { siteName, year }
  },
